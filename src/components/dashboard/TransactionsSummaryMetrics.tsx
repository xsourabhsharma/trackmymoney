  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 animate-stagger">
      <div className="bg-[var(--bg-surface)] border border-[var(--border-light)] rounded-2xl p-6 text-center shadow-sm hover-lift hover-glow">
        ...
        <div className="text-[12px] font-bold text-[var(--text-muted)] uppercase tracking-[0.2em]">Current Period Inflow</div>
      </div>
      ...
      <div className="bg-[var(--bg-surface)] border border-[var(--border-light)] rounded-2xl p-6 text-center shadow-sm hover-lift hover-glow">
        ...
        <div className="text-[12px] font-bold text-[var(--text-muted)] uppercase tracking-[0.2em]">Current Period Outflow</div>
      </div>
      ...
      <div className="bg-[var(--bg-base)] border border-[var(--border-light)] rounded-2xl p-6 text-center shadow-sm relative overflow-hidden hover-lift hover-glow">
        ...
        <div className="relative z-10 text-[12px] font-bold text-[var(--text-muted)] uppercase tracking-[0.2em]">Net Position</div>
      </div>
    </div>
  )
}
