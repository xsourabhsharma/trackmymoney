    ...
    <div className="bg-[var(--bg-base)] border border-[var(--border-light)] rounded-[24px] overflow-hidden shadow-sm flex flex-col h-full min-h-[600px]">
      ...
      <div className="p-6 border-b border-[var(--border-light)] bg-[var(--bg-surface)] flex justify-between items-center z-20 relative">
        ...
        {job && (
          <div className="flex items-center gap-6">
            ...
            <button onClick={cancelJob} className="text-[10px] font-bold text-[var(--text-muted)] hover:text-[var(--expense-red)] transition-colors flex items-center gap-1">
      ...
      {!job ? (
        ...
        >
          ...
          {error && (
            <div className="mt-6 px-4 py-2 bg-[var(--expense-red)]/10 text-[var(--expense-red)] border border-[var(--expense-red)]/20 rounded-lg text-[10px] font-bold tracking-widest uppercase flex items-center gap-2">
        ...
        <div className="flex flex-col lg:flex-row flex-grow overflow-hidden">
            ...
            <div className="p-4 bg-[var(--bg-base)] border-b border-[var(--border-light)] flex items-center justify-between gap-4">
              <div className="flex gap-4">
                 <button 
                  ...
                  className="px-4 py-2 bg-[var(--bg-surface)] border border-[var(--border-light)] rounded-lg text-[10px] font-bold tracking-widest uppercase flex items-center gap-2 hover:border-[var(--text-main)] transition-colors disabled:opacity-50"
                 >
              ...
              <div className="text-[10px] font-bold text-[var(--text-muted)] uppercase tracking-widest flex items-center gap-4">
              ...
              <table className="w-full text-left min-w-[900px]">
                <thead className="sticky top-0 bg-[var(--bg-surface)] z-10 shadow-sm">
                  <tr>
                    ...
                    <th className="p-4 text-[9px] font-bold text-[var(--text-muted)] uppercase tracking-widest">Date</th>
                    <th className="p-4 text-[9px] font-bold text-[var(--text-muted)] uppercase tracking-widest">Merchant / Description</th>
                    <th className="p-4 text-[9px] font-bold text-[var(--text-muted)] uppercase tracking-widest">Type</th>
                    <th className="p-4 text-[9px] font-bold text-[var(--text-muted)] uppercase tracking-widest">Category</th>
                    <th className="p-4 text-[9px] font-bold text-[var(--text-muted)] uppercase tracking-widest text-right">Amount</th>
                  </tr>
                </thead>
                    ...
                    >
                      ...
                      <td className="p-4">
                        <div className="flex items-center gap-2">
                           ...
                           {row.is_duplicate_guess && <span className="px-2 py-0.5 rounded text-[8px] uppercase tracking-wider font-bold bg-[var(--warn-yellow)]/20 text-[#b45309]">Duplicate</span>}
                           {isLowConfidence && <span className="px-2 py-0.5 rounded text-[8px] uppercase tracking-wider font-bold bg-[var(--accent)]/20 text-[var(--accent)]">Review</span>}
                        ...
                        {row.parsed_merchant !== row.parsed_description && (
                          <div className="text-[9px] font-medium text-[var(--text-muted)] truncate max-w-[250px] mt-0.5" title={row.parsed_description || ''}>
                      ...
                      <td className="p-4">
                        <select
                          ...
                          className="px-2 py-1 rounded-md bg-[var(--bg-surface)] border border-[var(--border-light)] text-[10px] uppercase font-bold tracking-widest text-[var(--text-main)] cursor-pointer focus:outline-none focus:ring-1 focus:ring-[var(--accent)]"
                        >
                      ...
                      <td className="p-4">
                        <select
                          ...
                          className="px-2 py-1 rounded-md bg-[var(--bg-surface)] border border-[var(--border-light)] text-[10px] uppercase font-bold tracking-widest text-[var(--text-main)] cursor-pointer focus:outline-none focus:ring-1 focus:ring-[var(--accent)] max-w-[160px]"
                        >
          ...
          <div className="w-full lg:w-[320px] bg-[var(--bg-surface)] p-6 flex flex-col justify-between shrink-0">
            <div>
              <h4 className="text-[10px] font-bold text-[var(--text-muted)] uppercase tracking-[0.2em] mb-6">Import Summary</h4>
              ...
              <div className="pt-6 mt-6 border-t border-[var(--border-light)]">
                <label className="text-[10px] font-bold text-[var(--text-muted)] uppercase tracking-[0.2em] mb-2 block">
                  Target Account
                </label>
                <select
